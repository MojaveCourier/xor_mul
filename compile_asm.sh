nasm -f elf64 gf_vect_dot_prod_avx2.asm -o gf_vect_dot_prod_avx2.o
nasm -f elf64 gf_2vect_dot_prod_avx2.asm -o gf_2vect_dot_prod_avx2.o
nasm -f elf64 gf_3vect_dot_prod_avx2.asm -o gf_3vect_dot_prod_avx2.o
